...
demo_df <- transform(demo_raw, 
                    ...
                    SOURCE_DATABASE = as.factor(STUDY_PAT_ID),
                    ...
                    EDUCATION_YEARS = as.character(EDUCATION_YEARS), # this will require some cleaning 
...
String value of "NA" not converted to true `NA`. Here we convert.
